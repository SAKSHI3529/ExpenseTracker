...
const Alert = ({ type = "info", message }) => {
  const alertStyles = {
    ...
    dark: "text-gray-800 border-gray-300 bg-gray-50 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-300",
  };



  return (
    <div className={`flex items-center p-4 mb-4 text-sm border rounded-lg ${alertStyles[type]}`} role="alert">
      {/* Alert Icon */}
