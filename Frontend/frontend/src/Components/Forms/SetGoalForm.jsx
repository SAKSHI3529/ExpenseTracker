  ...
  useEffect(() => {
    ...
    return (
      <div className="p-10 bg-white dark:bg-[#1e1e1e8a] shadow-md rounded-lg lg:w-[700px]">
        <h2 className="text-2xl font-bold mb-4 pb-4 text-gray-800 dark:text-white">Add Goal</h2>
        <form>
          ...
          {/* Amount */}
          <div className="flex flex-col mb-4">
            <label className="text-base mb-1">Goal Amount</label>
            <input 
              type="number" 
          ...
          {/* <div className="flex flex-col mb-4">
            <label className="text-base mb-1">Current Amount</label>
            <input 
              type="number" 
              placeholder="Enter Amount" 
              className="w-full p-2 border rounded"
           ...
           {/* Date - Auto-filled */}
           <div className="flex flex-col mb-4">
            <label className="text-base mb-1">start Date</label>
            <input 
              type="date" 
              value={date} 
          ...
          <div className="flex flex-col mb-4">
            <label className="text-base mb-1">Target Date</label>
            <input 
              type="date" 
              value={date} 
              onChange={(e) => setDate(e.target.value)} 
